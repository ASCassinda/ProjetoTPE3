...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-9">
                <div class="row">
                    <h1 class="logoTipo"><i class="fa fa-calendar-check-o">&nbsp;</i> Minhas Marcacões</h1>
                    ...
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="Tbnomebd">ESTADO</th>
                            </tr>
                        </thead>
                        <tbody>

                            <?php foreach ($marcacaoDAO->visualizarAllMarcacoes($idUtilizador) as $dados): ?>
                                <tr  class="Tbnomebd">
