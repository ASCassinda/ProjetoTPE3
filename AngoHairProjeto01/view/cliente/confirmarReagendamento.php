                ...
                <div class="row">
                    ...
                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($marcacaoDAO->visualizarMarcacoesBloqueadas($idUtilizador) as $dados): ?>
                                                <tr  class="Tbnomebd">
                                                    ...
                                                    <td>
                                                        <a href="../../controller/controllerActivarConfirmarCancelarReagendamento.php?activar=true&id=<?php echo $dados["idMarcacao"]; ?>" class="btn btn-info " title="Editar Marcacão"><i class="fa fa-thumbs-o-up"></i></a> 
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
