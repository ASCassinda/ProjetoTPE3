...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-9">
                <div class="row">
                    <h1 class="logoTipo"><i class="fa fa-edit"></i>&nbsp;&nbsp;Editar Reagendamentos</h1>
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="Tbnomebd">REAGENDAR</th>
                            </tr>
                        </thead>
                        <tbody>

                            <?php foreach ($marcacaoDAO->visualizarMarcacoes($idUtilizador) as $dados): ?>
                                <tr  class="Tbnomebd">
                                    ...
                                    <td>
                                        <a href="dadosAlteracaoReagendamento.php?idMarcacao=<?php echo $dados["idMarcacao"]; ?>" class="btn btn-info " title="Editar Marcacão"><i class="fa fa-edit"></i></a> 
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
