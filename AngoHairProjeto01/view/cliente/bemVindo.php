...
<html lang="pt-br">
    ...
    <body>
                                    ...
                                    <li class="col-md-9">
                                        <div  class="jumbotron" id="thumb">
                                            ...
                                            <div class="btnAlterar">
                                                ...
                                                <a class="navEdit"  data-target="#myModal" data-toggle="modal">Alterar Dados</a>
                                            </div>
        ...
        <section id="BemVindoCliente">
            
            <div class="ClienteEdit">
                <figure>
                    <figcaption>
                        <h1 id="testo1">Bem Vindo</h1>
                        <h2 id="testo2"><?php echo $dados['nomeUtilizador'];?></h2>
                    </figcaption>
                </figure>
            </div>
        </section>
        ...
        <script src="../content/js/scriptEfeitoBemVindo.js" type="text/javascript"></script>
