...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-9">
                <div class="row">
                    <h1 class="logoTipo"><i class="fa fa-calendar-check-o"></i>&nbsp;Reagendar Pedidos de marccão</h1>
                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($marcacaoDAO->visualizarMarcacoesConfirmadas() as $dados): ?>
                                                <tr  class="Tbnomebd">
                                                    ...
                                                    <td>
                                                        <a href="dadosAlteracaoData.php?reagendar=true&id=<?php echo $dados["idMarcacao"]; ?>" class="btn btn-info " title="Reagendar Marcacão"><i class="fa fa-calendar-check-o"></i></a> 
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
