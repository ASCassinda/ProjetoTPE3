...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-9">
                <div class="row">
                    <h1 class="logoTipo"><i class="fa fa-list"></i>&nbsp;Profissionais mais solicitados</h1>
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($marcacaoDAO->visualizarProfissionaisMaisSolicitados() AS $dados): ?>
                                <tr  class="Tbnomebd">
                                    <td><?php echo $dados['nomeProfissional']; ?></td>
                                    <td><?php echo $dados['Quantidade marcacoes atendidass']; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
