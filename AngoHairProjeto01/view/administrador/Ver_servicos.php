...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-9">
                <div class="row">
                    <h1 class="logoTipo"><i class="fa fa-list"></i>&nbsp;Serviços</h1>
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th class="Tbnomebd">SERVIÇO</th>
                                <th class="Tbnomebd">QTD SERVIÇOS</th>
                            </tr>
                        </thead>
                        <tbody>

                            <?php foreach ($marcacaoDAO->visualizarServicosMaisSolicitados() AS $dados): ?>
                                <tr  class="Tbnomebd">
                                    <td><?php echo $dados['servico']; ?></td>
                                    <td><?php echo $dados['Quantidade de servicos solicitados']; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
