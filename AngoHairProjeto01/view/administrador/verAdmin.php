...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-9">
                <div class="row">
                    <h1 class="logoTipo"><i class="fa fa-list"></i>&nbsp;Administrativos</h1>
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="Tbnomebd">OPÇÃO</th>
                            </tr>
                        </thead>
                        <tbody>

                            <?php foreach ($usuarioDAO->listar(4) as $dados): ?>
                                <tr  class="Tbnomebd">
                                    <td><?php echo $dados['nomeUtilizador']; ?></td>
                                    <td><?php echo $dados['email']; ?></td>
                                    <td><?php echo $dados['telemovel']; ?></td>
                                    <td><a href="../../controller/controllerEliminarAdministrativo.php?deletar=true&id=<?php echo $dados['idUtilizador']; ?>" class="btn btn-danger btn-block"><i class="fa fa-trash"></i></a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
