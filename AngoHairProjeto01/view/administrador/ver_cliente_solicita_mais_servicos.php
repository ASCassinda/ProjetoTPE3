...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-9">
                <div class="row">
                    <h1 class="logoTipo"><i class="fa fa-list"></i>&nbsp;Serviços mais solicitados por clientes</h1>
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th class="Tbnomebd">Nome</th>
                                <th class="Tbnomebd">Qtd serviços</th>
                            </tr>
                        </thead>
                        <tbody>

                            <?php foreach ($marcacaoDAO->visualizarClientesQueSolicitamMaisServicos() AS $dados): ?>
                                <tr  class="Tbnomebd">
                                    <td><?php echo $dados['Cliente']; ?></td>
                                    <td><?php echo $dados['Quantidades de servicos solicitados']; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
