...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-9">
                <div class="row">
                    <h1 class="logoTipo"><i class="fa fa-arrows-alt"></i>&nbsp;Contas bloqueadas</h1>
                    <table class="table table-bordered table-responsive">
                        ...
                        <tbody>
                            <?php foreach ($usuarioDAO->listar(3) as $dados): ?>
                                <tr class="Tbnomebd">
                                    <td><?php echo $dados['nomeUtilizador']; ?></td>
                                    <td><?php echo $dados['email']; ?></td>
                                    <td><?php echo $dados['telemovel']; ?></td>
                                    <td>
                                        <a href="../../controller/controllerActivarBloquearContasClientes.php?bloquear=true&id=<?php echo $dados['idUtilizador']; ?>" class="btn btn-info btn-block" title="Ativar">
